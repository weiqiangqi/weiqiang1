...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //新闻列表
    NewsListController *newsVC = [NewsListController new];
    //图片列表
...
//    UINavigationController * videoNC = [[UINavigationController alloc]initWithRootViewController:videoVC];
 ...
 MyController * myVC = [[MyController alloc]init];
    ...
    NSArray * array = @[newsVC,pictureVC,videoVC,myVC];
    
    UITabBarController *  tabBarNC = [[UITabBarController alloc]init];
    tabBarNC.viewControllers = array;
...
#pragma mark --WeiboSDKDelegate--事件
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "wq.com.WQNews" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"WQNews" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"WQNews.sqlite"];
    NSError *error = nil;
